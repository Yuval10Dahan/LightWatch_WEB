...
def test_alarms_and_events(page, left_panel):
    ...
    #     lw_alarms = ae.get_all_alarms()
    #     number_of_alarms = len(lw_alarms)
    #     print(f"Number of alarms: {number_of_alarms}")

    #     # Try ack/un-ack alarms with index in range 0 to number_of_alarms - 1 (best-effort)
    ...
    # # ----------------------------
    # # Step 13: Hide Event + Show Hidden Events
    # # ----------------------------
    # def step_13():
    #     refresh_page(page)
    #     sleep(5)
    ...
    #         # Show hidden events
    #         ae.show_hidden_events()
            
    #         # Verify hidden event is no longer hidden
    #         hidden_events = ae.get_all_hidden_events()
    #         print(f"Hidden events count: {len(hidden_events)}")
            
    #         if hidden_events:
    #             print(f"Sample hidden event: {hidden_events[0]}")
    #         else:
    #             print("No hidden events found after show_hidden_events().")
    #     else:
    #         print("No events found (table empty) – skipping Hide Event checks.")

    # run_step(13, "Alarms & Events: Hide Event + Show Hidden Events", step_13)
