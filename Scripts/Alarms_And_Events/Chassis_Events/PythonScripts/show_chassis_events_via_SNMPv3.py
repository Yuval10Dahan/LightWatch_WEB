...
Comprehensive Events Test - Show Chassis Events via SNMPv3
=====================================================
Tests the Chassis Events using SNMPv3.
...
LOGGER_DIRECTORY_NAME = "show_chassis_events_via_SNMPv3"
LOG_FILE_NAME = 'show_chassis_events_via_SNMPv3.log'
REPORT_PATH = None
...
def test_show_chassis_events_via_SNMPv3(page, left_panel: LeftPanel, logger, report):
...
if __name__ == "__main__":
   ...
   with sync_playwright() as p:
      ...
      test_show_chassis_events_via_SNMPv3(page, left_panel, logger, report)
