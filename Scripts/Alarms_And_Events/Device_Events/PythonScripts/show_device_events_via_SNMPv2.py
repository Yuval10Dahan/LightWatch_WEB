...
Comprehensive Events Test - Show Device Events via SNMPv2
=====================================================
Tests the Device Events using SNMPv2.
...
def test_show_device_events_via_SNMPv2(page, left_panel: LeftPanel, logger, report):
...
if __name__ == "__main__":
    ...
    with sync_playwright() as p:
        ...
        test_show_device_events_via_SNMPv2(page, left_panel, logger, report)
